...
export default function TrialPlansView({ selectedPlan, onSelectPlan }) {
    const router = useRouter();
    const selectedIndex = trialPlans.findIndex((plan) => plan.id === selectedPlan);
    const orderedPlans = [...trialPlans];

    if (selectedIndex > 0) {
        const [selectedItem] = orderedPlans.splice(selectedIndex, 1);
        orderedPlans.unshift(selectedItem);
    }
